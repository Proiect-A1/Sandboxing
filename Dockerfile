...
RUN apt-get update && apt full-upgrade -y && apt-get install -y unzip git iptables vim openssl acl sudo g++ rustc golang clang zlib1g-dev libseccomp-dev libwebsockets-dev debootstrap python3 && rm -rf /var/lib/apt/lists/*
