...
std::map<language_enum, const std::vector<int>> allowed_syscalls = {
  {language_enum::C, {
        SCMP_SYS(brk), SCMP_SYS(close), SCMP_SYS(dup3), SCMP_SYS(execve), 
        SCMP_SYS(exit), SCMP_SYS(exit_group), SCMP_SYS(faccessat), SCMP_SYS(fchownat), 
        ...
        SCMP_SYS(getgid), SCMP_SYS(getpid), SCMP_SYS(getppid), SCMP_SYS(getrandom), 
        ...
        SCMP_SYS(newfstatat), SCMP_SYS(openat), SCMP_SYS(prctl), SCMP_SYS(pread64), 
        SCMP_SYS(read), SCMP_SYS(readlinkat), SCMP_SYS(rseq), SCMP_SYS(rt_sigaction), 
        SCMP_SYS(rt_sigprocmask), SCMP_SYS(rt_sigreturn), SCMP_SYS(set_robust_list), 
        SCMP_SYS(set_tid_address), SCMP_SYS(statfs), SCMP_SYS(statx), SCMP_SYS(umask), 
        SCMP_SYS(uname), SCMP_SYS(write), SCMP_SYS(writev)
    }},
    {language_enum::CPP, {
        SCMP_SYS(brk), SCMP_SYS(clock_getres), SCMP_SYS(clock_gettime), 
        SCMP_SYS(clock_nanosleep), SCMP_SYS(close), SCMP_SYS(dup3), SCMP_SYS(execve), 
        SCMP_SYS(exit), SCMP_SYS(exit_group), SCMP_SYS(faccessat), SCMP_SYS(fchownat), 
        SCMP_SYS(fcntl), SCMP_SYS(fstat), SCMP_SYS(fstatfs), SCMP_SYS(futex), 
        SCMP_SYS(get_mempolicy), SCMP_SYS(getcpu), SCMP_SYS(getcwd), SCMP_SYS(getdents64), 
        SCMP_SYS(getegid), SCMP_SYS(geteuid), SCMP_SYS(getgid), SCMP_SYS(getgroups), 
        SCMP_SYS(getpgid), SCMP_SYS(getpid), SCMP_SYS(getppid), SCMP_SYS(getpriority), 
        SCMP_SYS(getrandom), SCMP_SYS(getresgid), SCMP_SYS(getresuid), SCMP_SYS(getrlimit), 
        SCMP_SYS(getrusage), SCMP_SYS(getsid), SCMP_SYS(gettid), SCMP_SYS(getuid), 
        SCMP_SYS(ioctl), SCMP_SYS(lseek), SCMP_SYS(madvise), SCMP_SYS(mbind), 
        ...
        SCMP_SYS(sched_getparam), SCMP_SYS(sched_getscheduler), SCMP_SYS(sched_setaffinity), 
        SCMP_SYS(sched_yield), SCMP_SYS(set_mempolicy), SCMP_SYS(set_robust_list), 
        SCMP_SYS(set_tid_address), SCMP_SYS(setgid), SCMP_SYS(setgroups), 
        ...
        SCMP_SYS(tgkill), SCMP_SYS(tkill), SCMP_SYS(umask), SCMP_SYS(uname), 
