...
std::map<language_enum, std::vector<int>> allowed_syscalls = {
    {language_enum::C, {
        ...
        SCMP_SYS(faccessat), SCMP_SYS(fstatfs), SCMP_SYS(futex), SCMP_SYS(getpid),
        SCMP_SYS(getrandom), SCMP_SYS(gettid), SCMP_SYS(lseek), SCMP_SYS(madvise),
        SCMP_SYS(mmap), SCMP_SYS(mprotect), SCMP_SYS(mremap), SCMP_SYS(munmap),
        SCMP_SYS(newfstatat), SCMP_SYS(openat), SCMP_SYS(pread64), SCMP_SYS(preadv),
        ...
        SCMP_SYS(statfs), SCMP_SYS(statx), SCMP_SYS(write), SCMP_SYS(writev)
    }},
    {language_enum::CPP, {
        SCMP_SYS(brk), SCMP_SYS(close), SCMP_SYS(exit), SCMP_SYS(exit_group),
        SCMP_SYS(faccessat), SCMP_SYS(fstatfs), SCMP_SYS(futex), SCMP_SYS(getpid),
