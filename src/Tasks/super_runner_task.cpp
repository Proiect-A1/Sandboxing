...
std::map<language_enum, std::vector<int>> allowed_syscalls = {
    {language_enum::C, {
        ...
        SCMP_SYS(pwritev), SCMP_SYS(read), SCMP_SYS(readv), SCMP_SYS(rseq), 
        SCMP_SYS(rt_sigaction), SCMP_SYS(rt_sigprocmask), SCMP_SYS(rt_sigreturn), 
        SCMP_SYS(set_robust_list), SCMP_SYS(set_tid_address), SCMP_SYS(statfs), 
        SCMP_SYS(statx), SCMP_SYS(write), SCMP_SYS(writev)
    }},
    {language_enum::CPP, {
        SCMP_SYS(brk), SCMP_SYS(close), SCMP_SYS(exit), SCMP_SYS(exit_group),
        SCMP_SYS(faccessat), SCMP_SYS(fcntl), SCMP_SYS(fstatfs), SCMP_SYS(futex), 
