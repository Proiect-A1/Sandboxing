...
std::map<language_enum, const std::vector<int>> allowed_syscalls = {
   {language_enum::C, {
        ...
        SCMP_SYS(exit_group), SCMP_SYS(faccessat), SCMP_SYS(fcntl), SCMP_SYS(fstatfs), 
        SCMP_SYS(futex), SCMP_SYS(getegid), SCMP_SYS(geteuid), SCMP_SYS(getgid), 
        ...
        SCMP_SYS(openat), SCMP_SYS(prctl), SCMP_SYS(pread64), SCMP_SYS(read), 
        SCMP_SYS(readlinkat), SCMP_SYS(rseq), SCMP_SYS(rt_sigaction), SCMP_SYS(rt_sigprocmask), 
    ...
    {language_enum::CPP, {
        ...
        SCMP_SYS(fstatfs), SCMP_SYS(futex), SCMP_SYS(getegid), SCMP_SYS(geteuid), 
        ...
        SCMP_SYS(prlimit64), SCMP_SYS(read), SCMP_SYS(readlinkat), SCMP_SYS(rseq), 
        ...
        SCMP_SYS(set_tid_address), SCMP_SYS(sigaltstack), SCMP_SYS(statx), 
