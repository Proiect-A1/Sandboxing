...
std::map<language_enum, std::vector<int>> allowed_syscalls = {
    {language_enum::C, {
        SCMP_SYS(brk), SCMP_SYS(clock_gettime), SCMP_SYS(close), SCMP_SYS(exit), 
        SCMP_SYS(exit_group), SCMP_SYS(faccessat), SCMP_SYS(faccessat2), SCMP_SYS(fcntl), 
        SCMP_SYS(fstatfs), SCMP_SYS(futex), SCMP_SYS(getcwd), SCMP_SYS(getegid), 
        ...
        SCMP_SYS(munmap), SCMP_SYS(newfstatat), SCMP_SYS(openat), SCMP_SYS(prctl), 
        SCMP_SYS(pread64), SCMP_SYS(preadv), SCMP_SYS(prlimit64), SCMP_SYS(pwrite64), 
        SCMP_SYS(pwritev), SCMP_SYS(read), SCMP_SYS(readv), SCMP_SYS(readlinkat), 
        ...
        SCMP_SYS(sigaltstack), SCMP_SYS(statfs), SCMP_SYS(statx), SCMP_SYS(sysinfo), 
    ...
    {language_enum::RUST, {
        SCMP_SYS(brk), SCMP_SYS(clock_gettime), SCMP_SYS(clock_nanosleep), 
        ...
        SCMP_SYS(epoll_pwait), SCMP_SYS(eventfd2), SCMP_SYS(exit), SCMP_SYS(exit_group), 
        SCMP_SYS(faccessat), SCMP_SYS(fcntl), SCMP_SYS(fstatfs), SCMP_SYS(futex),
        SCMP_SYS(getcwd), SCMP_SYS(getdents64), SCMP_SYS(getegid), SCMP_SYS(geteuid), 
        SCMP_SYS(getgid), SCMP_SYS(getpid), SCMP_SYS(getrandom), SCMP_SYS(getrlimit), 
        SCMP_SYS(gettid), SCMP_SYS(getuid), SCMP_SYS(ioctl), SCMP_SYS(lseek), 
        SCMP_SYS(madvise), SCMP_SYS(membarrier), SCMP_SYS(mmap), SCMP_SYS(mprotect), 
        SCMP_SYS(mremap), SCMP_SYS(munmap), SCMP_SYS(newfstatat), SCMP_SYS(openat), 
        SCMP_SYS(pipe2), SCMP_SYS(ppoll), SCMP_SYS(prctl), SCMP_SYS(pread64), 
        SCMP_SYS(preadv), SCMP_SYS(prlimit64), SCMP_SYS(pwrite64), SCMP_SYS(pwritev), 
        SCMP_SYS(read), SCMP_SYS(readv), SCMP_SYS(readlinkat), SCMP_SYS(restart_syscall), 
        SCMP_SYS(rseq), SCMP_SYS(rt_sigaction), SCMP_SYS(rt_sigprocmask), 
        SCMP_SYS(rt_sigreturn), SCMP_SYS(sched_getaffinity), SCMP_SYS(sched_yield),
        SCMP_SYS(set_robust_list), SCMP_SYS(set_tid_address), SCMP_SYS(sigaltstack), 
        SCMP_SYS(statfs), SCMP_SYS(statx), SCMP_SYS(sysinfo), SCMP_SYS(uname),
        SCMP_SYS(write), SCMP_SYS(writev)
    }},
    {language_enum::PYTHON, {
        SCMP_SYS(brk), SCMP_SYS(clock_getres), SCMP_SYS(clock_gettime), 
        SCMP_SYS(clock_nanosleep), SCMP_SYS(clone), SCMP_SYS(clone3), SCMP_SYS(close), 
        SCMP_SYS(dup), SCMP_SYS(dup2), SCMP_SYS(dup3), SCMP_SYS(epoll_create1), 
        SCMP_SYS(epoll_ctl), SCMP_SYS(epoll_pwait), SCMP_SYS(eventfd2), SCMP_SYS(exit), 
        SCMP_SYS(exit_group), SCMP_SYS(faccessat), SCMP_SYS(fchmod), SCMP_SYS(fchmodat), 
        SCMP_SYS(fcntl), SCMP_SYS(fstatfs), SCMP_SYS(ftruncate), SCMP_SYS(futex),
        SCMP_SYS(getcwd), SCMP_SYS(getdents64), SCMP_SYS(getegid), SCMP_SYS(geteuid), 
        SCMP_SYS(getgid), SCMP_SYS(getgroups), SCMP_SYS(getpid), SCMP_SYS(getppid), 
        SCMP_SYS(getrandom), SCMP_SYS(getresgid), SCMP_SYS(getresuid), SCMP_SYS(getrlimit), 
        SCMP_SYS(getrusage), SCMP_SYS(gettid), SCMP_SYS(getuid), SCMP_SYS(ioctl), 
        SCMP_SYS(lseek), SCMP_SYS(madvise), SCMP_SYS(mmap), SCMP_SYS(mprotect), 
        SCMP_SYS(mremap), SCMP_SYS(munmap), SCMP_SYS(nanosleep), SCMP_SYS(newfstatat), 
        SCMP_SYS(openat), SCMP_SYS(pipe2), SCMP_SYS(pkey_alloc), SCMP_SYS(pkey_mprotect),
        SCMP_SYS(ppoll), SCMP_SYS(prctl), SCMP_SYS(pread64), SCMP_SYS(preadv), 
        SCMP_SYS(prlimit64), SCMP_SYS(pselect6), SCMP_SYS(pwrite64), SCMP_SYS(pwritev), 
        SCMP_SYS(read), SCMP_SYS(readv), SCMP_SYS(readlinkat), SCMP_SYS(renameat2), 
        SCMP_SYS(restart_syscall), SCMP_SYS(rseq), SCMP_SYS(rt_sigaction), 
        SCMP_SYS(rt_sigprocmask), SCMP_SYS(rt_sigreturn), SCMP_SYS(rt_sigtimedwait), 
        SCMP_SYS(sched_getaffinity), SCMP_SYS(sched_yield), SCMP_SYS(set_robust_list), 
        SCMP_SYS(set_tid_address), SCMP_SYS(sigaltstack), SCMP_SYS(statfs), 
        SCMP_SYS(statx), SCMP_SYS(sysinfo), SCMP_SYS(times), SCMP_SYS(umask), 
        SCMP_SYS(uname), SCMP_SYS(unlinkat), SCMP_SYS(wait4), SCMP_SYS(write),
        SCMP_SYS(writev)
    }}
};
